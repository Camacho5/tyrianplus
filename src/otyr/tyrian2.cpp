...
#include "otyr/pcxload.hpp"
#include "otyr/pcxmast.hpp"
#include "otyr/picload.hpp"
#include "otyr/shots.hpp"
...
bool titleScreen(void)
{
	...
	for (; ; )
	{
		if (restart)
		{
			...
			draw_font_hv_shadow(VGAScreen, 2, 192, progver_str, small_font, left_aligned, 15, 0, false, 1);
